  ...
  constructor(endPoint, options) {
    ...
    this._resolveFetch = (customFetch) => {
      ...
      if (customFetch) {
        ...
        _fetch = (...args) => import("./browser-HUQ7SECI.js").then(({ default: fetch2 }) => fetch2(...args)).catch((error) => {
...
var resolveFetch4 = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = async (...args) => await (await import("./browser-ponyfill-GO6XV3ET.js")).fetch(...args);
  } else {
    _fetch = fetch;
  }
  return (...args) => _fetch(...args);
